...
interface TextareaProps {
  ...
  onChange?: (e: React.ChangeEvent<HTMLTextAreaElement>) => void; // Change handler - modified to pass the event
...
const TextArea: React.FC<TextareaProps> = ({
  ...
  const handleChange = (e: React.ChangeEvent<HTMLTextAreaElement>) => {
    if (onChange) {
      onChange(e); // Pass the entire event object, not just the value
    }
  };
